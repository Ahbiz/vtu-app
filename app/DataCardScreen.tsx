...
export default function DataCardScreen() {
    ...
    const DATA_PLANS = ["1GB - 30 Days", "2GB - 30 Days", "5GB - 30 Days", "10GB - 30 Days"];
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Data Card PINs</Text>
            ...
            <View style={styles.bottomContainer}>
                <TouchableOpacity style={styles.payBtn}>
                    <Text style={styles.payBtnText}>Generate Data PINs</Text>
                </TouchableOpacity>
            </View>

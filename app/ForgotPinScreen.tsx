    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.title}>Forgot Transaction PIN?</Text>
                <Text style={styles.subtitle}>
                    Enter your registered email address or phone number below. We'll send you an OTP to reset your PIN.
                </Text>
            ...
            <View style={styles.bottomContainer}>
                <TouchableOpacity style={styles.resetBtn} onPress={() => router.push("/ResetPinOtpScreen" as any)}>
                    <Text style={styles.resetBtnText}>Send Reset OTP</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 22, fontFamily: "Poppins_700Bold", color: "#111", textAlign: "center", marginBottom: 12 },
    ...
    resetBtn: { backgroundColor: "#0052CC", height: 56, borderRadius: 12, justifyContent: "center", alignItems: "center" },
    resetBtnText: { fontSize: 16, fontFamily: "Poppins_600SemiBold", color: "#FFFFFF" },
});

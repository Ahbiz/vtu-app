...
export default function CreateNewPasswordScreen() {
    ...
    const otpStr = Array.isArray(otp) ? otp[0] : otp || '';
    ...
    const handleContinue = async () => {
        ...
        if (password.length < 8 || !hasLetter || !hasNumber) {
            Alert.alert("Error", "Password must be at least 8 characters and contain a letter and a number.");
            return;
        }
...
const styles = StyleSheet.create({
    ...
    label: { color: "#333333", fontSize: 14, fontWeight: "500", marginBottom: 8 },
    passwordInputRow: { flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderBottomColor: "#E0E0E0", paddingBottom: 6 },
    input: { flex: 1, fontSize: 16, fontWeight: "500", color: "#111111", paddingVertical: 6 },
    eyeIcon: { padding: 5 },
    helperText: { fontSize: 13, color: "#666666", marginTop: 8, lineHeight: 18 },
    boldText: { fontWeight: "700", color: "#333333" },
